...
export default function AppraisalKeyAreasPage() {
  return <GenericModule title="Appraisal key areas" endpoint="appraisal-key-areas"
    ...
    fields={[
      {key:'HRMS_appraisal_id',label:'Appraisal',required:true,type:'lov',lovEndpoint:'appraisals',labelFn:o=>{const e=o._empName||o.HRMS_employee_id; return e?`${e} – ${o.review_period||''}`:o._displayId||o.id;},tooltip:'Shows employee name + period, not APR1'},
