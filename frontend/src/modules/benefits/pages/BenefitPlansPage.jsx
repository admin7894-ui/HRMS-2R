...
export default function BenefitPlansPage() {
  return <GenericModule title="Benefit plans" endpoint="benefit-plans"
    ...
    columns={[{key:'benefit_plan_name',label:'Plan name'},{key:'benefit_plan_type',label:'Type',type:'badge'},{key:'coverage',label:'Coverage (lakhs)'}]}
    fields={[
      ...
      {key:'benefit_plan_type',label:'Plan type',type:'select',options:[
        {v:'HEALTH',l:'Health'},
        {v:'LIFE',l:'Life'},
        {v:'PROVIDENT_FUND',l:'Provident Fund'},
        {v:'GRATUITY',l:'Gratuity'},
        {v:'ALLOWANCE',l:'Allowance'},
        {v:'BONUS_INCENTIVE',l:'Bonus & Incentive'},
        {v:'RETIREMENT',l:'Retirement'},
        {v:'LEAVE_MATERNITY',l:'Leave & Maternity'},
        {v:'EDUCATION',l:'Education'},
        {v:'OTHER',l:'Other'}
      ]},
      {key:'specify_plan_type',label:'Specify Plan Type',required:true,type:'alpha',maxLen:50,hidden:f=>f.benefit_plan_type!=='OTHER',tooltip:'Required when Other is selected; alphabets only'},
