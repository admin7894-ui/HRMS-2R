...
export default function EmployeesPage() {
  return <GenericModule title="Employees" endpoint="employees"
    ...
    fields={[
      ...
      {key:'First_Name',      label:'First name',  required:true, type:'alpha', section:'Personal'},
      {key:'Middle_Name',     label:'Middle name', type:'alpha', section:'Personal'},
      ...
      {key:'Prev_Company_Name', label:'Previous company',      section:'Experience'},
      {key:'Industry_Type',     label:'Previous industry name',section:'Experience'},
      {key:'Prev_Department',   label:'Previous department',   section:'Experience'},
      {key:'Prev_Designation',  label:'Previous designation',  section:'Experience'},
